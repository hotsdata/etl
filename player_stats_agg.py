...
dag = DAG(
    'player_stats_per_map_hero_gametype', default_args=default_args)
...
create_table = PostgresOperator(
    ...
    sql=Template("""
        ...
        create index IF NOT EXISTS stg_ps_2
            on {{stg_table_2}} (battletag, toonhandle)
        ;
        CREATE INDEX IF NOT EXISTS process_date_stg_2
        ON {{stg_table_2}} (process_date);
...
insert_stg_player_stats_2 = PostgresOperator(
    task_id='insert_stg_player_stats_2',
    postgres_conn_id='hotstats',
    dag=dag,
    sql=Template("""
    ...
    """).render(stg_table_2=task_variables['STG_PLAYER_STATS_2'],
                stg_table_1=task_variables['STG_PLAYER_STATS_1'],
...
insert_stg_agg = PostgresOperator(
    task_id='insert_stg_player_stats_agg',
    postgres_conn_id='hotstats',
    dag=dag,
    sql=Template("""
